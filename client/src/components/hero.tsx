...
export default function Hero() {
  return (
    <div className="relative min-h-screen bg-black overflow-hidden" style={{ backgroundImage: 'url("https://jemwell9.github.io/Ethereal/Banner-bg-1.png")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="container mx-auto px-4 pt-24 pb-8 relative">
        ...
        <div className="relative mt-2">
          <div className="w-full max-w-6xl mx-auto mt-[-250px]">
            ...
            <img
              src="https://jemwell9.github.io/Ethereal/Jemwell-Project.png" // Replace this with the path to your image
