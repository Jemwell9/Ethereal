...
const services = [
  {
    ...
    img: "https://ethereal.sg/public/3d-pic.png", // Updated path to the image in the 'public' folder
    icon: "https://ethereal.sg/public/3d-icon.png", // Image path for icon
    reverse: false
  },
  {
    ...
    img: "https://ethereal.sg/public/autocad-pic.png", // Updated path to the image in the 'public' folder
    icon: "https://ethereal.sg/public/autocad-icon.png", // Image path for icon
    reverse: true
  },
  {
    title: "CONSULTATION",
    ...
    img: "https://ethereal.sg/public/consultation-pic.png", // Updated path to the image in the 'public' folder
    icon: "https://ethereal.sg/public/consultation-icon.png", // Image path for icon
    reverse: false
  },
  {
    ...
    img: "https://ethereal.sg/public/3d2-pic.png", // Updated path to the image in the 'public' folder
    icon: "https://ethereal.sg/public/3d2-icon.png", // Image path for icon
    reverse: true
  }
];
...
export default function Services() {
  return (
        <section id="services" className="py-20 bg-black/40 relative"
         style={{
         backgroundImage: 'url("https://ethereal.sg/public/featured-services-bg.png"), url("https://ethereal.sg/public/featured-services-bg-b.png")', // Add both images
