...
export default function Partners() {
  return (
    <section
      ...
      style={{
        backgroundImage: 'url("https://ethereal.sg/public/Banner-bg-2.png")',
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-8">
          <img
            src="https://ethereal.sg/public/Leading-brands.png" // Reference the image from the 'public' folder
            alt="Ethereal"
